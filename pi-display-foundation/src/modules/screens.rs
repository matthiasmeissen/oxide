...
where
    ...
    T::Error: Debug,
{
    draw_range(display, Point::new(19, 13), state.values[0] as f32, "CV1");
    draw_range(display, Point::new(19 + 27, 13), state.values[1] as f32, "CV2");
    draw_range(display, Point::new(19 + 27 * 2, 13), state.values[2] as f32, "CV3");
    draw_range(display, Point::new(19 + 27 * 3, 13), state.values[3] as f32, "CV4");
}


pub fn draw_range<T>(display: &mut T, position: Point, val: f32, label: &str)
where
    T: DrawTarget<Color = BinaryColor>,
    T::Error: Debug,
{
