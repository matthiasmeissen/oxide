...
#define POT1_SMOOTHING_FACTOR 0.1 // Low value = very smooth. Range: 0.0 to 1.0
#define POT1_HYSTERESIS_THRESHOLD 8 // The value must change by at least 8 (out of 4095) to be reported
...
AnalogInput pot1(POT1_PIN, POT1_SMOOTHING_FACTOR, POT1_HYSTERESIS_THRESHOLD);
...
void loop() {
  ...
  uint16_t stablePotValue = pot1.read();
  localState.pot1_value = stablePotValue / 4;
